...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_3 = "SELECT o.ogrno, o.ad, o.soyad, o.cinsiyet, o.sinif, o.puan, o.dtarih " +
            "FROM ogrenci o " +
    ...
    String QUESTION_9 = "SELECT o.ad, o.soyad, COUNT(i.ogrno) FROM ogrenci AS o RIGHT JOIN islem AS i ON o.ogrno = i.ogrno GROUP BY o.ad, o.soyad;";
